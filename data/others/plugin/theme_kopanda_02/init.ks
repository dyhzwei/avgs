...
;[position layer=message0 page=fore frame="../others/plugin/theme_kopanda_02/image/
;frame_message.png" margint="55" marginl="50" marginr="70" marginb="60" opacity=&mp.frame_opacity
;]
