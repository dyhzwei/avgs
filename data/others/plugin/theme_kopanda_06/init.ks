...
;	セーブボタン
	[button name="role_button" role="save" graphic="../others/plugin/theme_kopanda_06/image/button/save.png" enterimg="../others/plugin/theme_kopanda_06/image/button/save2.png" x="230" y="612"]

;	ロードボタン
	[button name="role_button" role="load" graphic="../others/plugin/theme_kopanda_06/image/button/load.png" enterimg="../others/plugin/theme_kopanda_06/image/button/load2.png" x="282" y="612"]

;	クイックセーブボタン
	[button name="role_button" role="quicksave" graphic="../others/plugin/theme_kopanda_06/image/button/qsave.png" enterimg="../others/plugin/theme_kopanda_06/image/button/qsave2.png" x="334" y="614"]

;	クイックロードボタン
	[button name="role_button" role="quickload" graphic="../others/plugin/theme_kopanda_06/image/button/qload.png" enterimg="../others/plugin/theme_kopanda_06/image/button/qload2.png" x="403" y="614"]
